...
public class BasePage {
   ...
   /* public void databaseInit() {
    ...
    public WebElement getElementsText(By byLocator, String text) {
        WebElement returnedElements = null;

        List<WebElement> elements = driver.findElements(byLocator);
        for (WebElement element : elements) {
            System.out.println("######### LOGGER: My ELementsssss are:" + element.getText());
            if (element.getText().equalsIgnoreCase(text)) {
                returnedElements = element;
                System.out.println("######### LOGGER: My ELement is:" + returnedElements);
                break;
    ...
    public void clickOnDatePicker(By byLocator, String text){
        getElementsText(byLocator,text).click();
    }

    public void clickHeaderWithText(By byLocator, String textValue) {
        getElementsText(byLocator, textValue).click();
    }


    public String getTrimmedElementText(WebElement element, String text) {
        // String text = "";
        webDriverWait.until(ExpectedConditions.visibilityOf(element));
    ...
    public void sendKeysOnly( String keys) {
        webDriverWait.until(ExpectedConditions.titleContains(keys));
        sendKeysOnly(keys);
    }
    ...
    public boolean isElementVisible(WebElement element) {
        WebElement myVisibleElement = fluentWait.until(ExpectedConditions.visibilityOf(element));
        try {
            if (myVisibleElement.isDisplayed()){
                System.out.println("########### LOGGER:  My Element was displayed ##########");
            }
        } catch (TimeoutException e) {
            System.out.println("########### LOGGER: My Element was not displayed and now I am throwing you a TimeoutException #########");
            return false;
        }
        return true;
    }
